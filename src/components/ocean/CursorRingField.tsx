...
export default function CursorRingField(props: CursorRingFieldProps) {
    const {
        ...
        speed = 6,
        cameraDistance = 160,
        ringRadius: topRingRadius,
        ringWidth: topRingWidth,
    ...
    const ringRadius = topRingRadius ?? ring.radius ?? 12
    const ringWidth = topRingWidth ?? ring.width ?? 9
    ...
    live.current = {
        ...
        dotSize: dotSize > 10 ? dotSize / 100 : dotSize,
        speed: speed / 50,
        camDist: cameraDistance / 100,
        ringRadius: ringRadius > 2 ? ringRadius / 100 : ringRadius,
        ringWidth: ringWidth > 1 ? ringWidth / 100 : ringWidth,
