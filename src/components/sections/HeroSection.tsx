  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute inset-x-5 bottom-[98px] sm:bottom-[clamp(28px,6vh,58px)] z-[5] mx-auto grid max-w-[1340px] grid-cols-1 items-end gap-[clamp(20px,4vh,40px)] transition-opacity duration-100 sm:inset-x-8 lg:inset-x-[4vw] lg:grid-cols-[minmax(300px,.72fr)_minmax(0,1.45fr)] lg:gap-[clamp(30px,4vw,68px)]"
      >
